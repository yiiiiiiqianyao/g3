...
THREE.HorizialController = function ( camera, domElement ) {
	...
	var _gizmo = new THREE.HorizialControllerGizmo();
	this.add( _gizmo );

	var _plane = new THREE.HorizialControllerPlane();
	this.add( _plane );
...
THREE.HorizialController.prototype = Object.assign( Object.create( THREE.Object3D.prototype ), {

  constructor: THREE.HorizialController,

  isHorizialController: true

} );


THREE.HorizialControllerGizmo = function () {

	'use strict';

	THREE.Object3D.call( this );

	this.type = 'HorizialControllerGizmo';
	...
	this.updateMatrixWorld = function () {
		...
		// this.helper[ "scale" ].visible = true
...
THREE.HorizialControllerGizmo.prototype = Object.assign( Object.create( THREE.Object3D.prototype ), {

	constructor: THREE.HorizialControllerGizmo,

	isHorizialControllerGizmo: true

} );


THREE.HorizialControllerPlane = function () {
	...
	this.type = 'HorizialControllerPlane';
...
THREE.HorizialControllerPlane.prototype = Object.assign( Object.create( THREE.Mesh.prototype ), {

	constructor: THREE.HorizialControllerPlane,

	isHorizialControllerPlane: true
